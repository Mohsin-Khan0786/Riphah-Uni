...
const Contact = () => {
  const handleSubmit = async (event) => {
    ...
    try {
      await firestore.collection("contactForm").add({
        fullName,
        email,
        subject,
        message,
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-10 col-lg-8">
              <h1 className=" mb-2 display-5 text-dark text-uppercase">
                Contact Us
              </h1>
              <h4 className="display-7 mb-4 mb-md-5 mb-xl-3 text-muted">
                  ...
                  <div className="mb-4 mb-md-5">
                    ...
                    <div>
                      ...
                      <address className="m-0 text-secondary">
                        Office # 2, Second Floor, Al-Haram Plaza, PIA Main
                        Boulevard, Lahore, 54770
                      </address>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <div className="d-flex mb-1">
                        ...
                        <p className="text-secondary mb-0">10am - 7pm</p>
                      </div>
                      <div className="d-flex">
                        <p className="text-secondary fw-bold mb-0 me-5">
                          Sat - Sun
                        </p>
                        <p className="text-secondary mb-0">OFF , OFF</p>
                      </div>
                    </div>
                  </div>
                </div>
