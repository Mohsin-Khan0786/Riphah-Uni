...
const Contact = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      await configapp.collection("contactForm").add({
  ...
  <section className="py-3 py-md-2 py-xl-5">
    <div className="container">
      <div className="row">
        <div className="col-12 col-md-10 col-lg-8">
          <h1 className=" mb-2 display-5 text-dark text-uppercase">Contact Us</h1>
          <h4 className="display-7 mb-4 mb-md-5 mb-xl-3 text-muted">We're always on the lookout to work with new clients. Please get in touch in one of the following ways.</h4>
        </div>
      </div>
    </div>
    <div className="container">
      <div className="row gy-4 gy-md-0 gy-lg-0 align-items-md-center">
  ...
  <div className="col-12">
    <div>
    <label htmlFor="subject" className="form-label">Subject </label><span className="text-danger mx-1">*</span>

    </div>
    <input type="text" className="form-control" placeholder="Subject" id="subject" name="subject" value={formData.subject} onChange={handleChange} required />
  </div>
  <div className="col-12">
    <label htmlFor="message" className="form-label">Message <span className="text-danger">*</span></label>
    <textarea className="form-control" placeholder="Message" id="message" name="message" rows={3} value={formData.message} onChange={handleChange} required />
  </div>
  <div className="col-12">
    <div className="d-grid">
      <button className="btn btn-primary btn-lg" type="submit">Send Message</button>
        ...
        <div className="col-12 col-lg-6 bgimg">
